...
{	
	...
	/*
	 * Compares 2 item codes from the Inventory passed in and returns if the first value was smaller
	 * @param i - first integer to be compared
	 * @param i2 - second integer to be compared
	 * @return result if i was lesser than i2(true or false);
	 */
